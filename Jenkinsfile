pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE = 'cithit/heltonsi'                                                                    //<------your MiamiID
        IMAGE_TAG = "build-${BUILD_NUMBER}"
        GITHUB_URL = 'https://github.com/heltonsi-dev/225-lab3-7.git'                                    //<------your MiamiID
        KUBECONFIG = credentials('heltonsi-225-sp26')                                                         //<------your MiamiID
    }
